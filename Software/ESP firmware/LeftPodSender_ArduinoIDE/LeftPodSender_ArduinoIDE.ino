...
constexpr uint8_t SENSOR_A_FREQ = 15;
constexpr uint8_t SENSOR_B_FREQ = 15;
...
bool setupSensor(SparkFun_VL53L5CX &sensor, uint8_t newAddr, uint8_t freq, int name)
{
  if (!sensor.begin()) {
    Serial.print(name);
...
void trySendSensor(SparkFun_VL53L5CX &sensor, VL53L5CX_ResultsData &results, uint8_t sensorId)
{
...
{
  Serial.begin(115200);
  Serial.println("Left Pod Serial Started");

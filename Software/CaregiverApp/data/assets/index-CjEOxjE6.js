(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`<svg viewBox="0 0 100 100">
  ...
  ${u}
  ${f}
</svg>`}function N(e){return e.ring===0?S:e.sector===`N`?T:e.sector===`SE`?w:e.sector===`SW`?C:E}function P(e){if(e.ring===0)return E;let t=e.angleDeg,n=e.ring;return n===1&&(t<5||t>325)||n===2&&(t<35||t>325)?T:n===3&&t>=100&&t<=140?w:n===5&&t>250&&t<295?C:E}function F(e){return e===4?D:e===8?k:O}function I(e){return Object.fromEntries(F(e).map(e=>[e,!0]))}function L(){return{audioEnabled:!1,visualEnabled:!1,selectedMode:null,selectedAudioMode:null,advanced:{thresholds:{redMax:60,yellowMax:150},sectorCount:6,detectionMode:2,activeSectors:I(6),brightness:100}}}var R=L(),z=!1,B=null,V=[20,50,100,150,200,300];function H(e){let t=V[e]??0;return t<=R.advanced.thresholds.redMax?T:t<=R.advanced.thresholds.yellowMax?w:C}function U(e){return R.advanced.activeSectors[e.sector]?H(e.ring):S}function W(){let e=document.getElementById(`advanced-preview`);if(!e)return;let t=F(R.advanced.sectorCount);e.innerHTML=M(220,U,R.advanced.brightness,!0,t)}function G(){let{thresholds:e,sectorCount:t,brightness:n,detectionMode:r}=R.advanced,i=F(t).map(e=>R.advanced.activeSectors[e]??!0);h({type:`config`,zoneMode:t,brightness:n,redThreshold:e.redMax,yellowThreshold:e.yellowMax,activeSectors:i,detectionMode:r,audioEnabled:R.audioEnabled,visualEnabled:R.visualEnabled})}function K(e){if(!e){h({type:`preview`,active:!1});return}let{thresholds:t,sectorCount:n,brightness:r}=R.advanced,i=F(n).map(e=>R.advanced.activeSectors[e]??!0);h({type:`preview`,active:!0,zoneMode:n,brightness:r,redThreshold:t.redMax,yellowThreshold:t.yellowMax,activeSectors:i})}function q(){return F(R.advanced.sectorCount).map(e=>`<button class="sector-toggle${R.advanced.activeSectors[e]??!1?` active`:``}" data-sector="${e}">${e}</button>`).join(``)}function J(e){let t=e.zoneMode,n=e.brightness,r=e.redThreshold,i=e.yellowThreshold,a=e.detectionMode,o=e.activeSectors,s=e.audioEnabled,c=e.visualEnabled;t!==void 0&&[4,6,8].includes(t)&&(R.advanced.sectorCount=t),n!==void 0&&(R.advanced.brightness=n),r!==void 0&&(R.advanced.thresholds.redMax=r),i!==void 0&&(R.advanced.thresholds.yellowMax=i),a!==void 0&&[0,1,2].includes(a)&&(R.advanced.detectionMode=a),o!==void 0&&F(R.advanced.sectorCount).forEach((e,t)=>{R.advanced.activeSectors[e]=o[t]??!0}),s!==void 0&&(R.audioEnabled=s),c!==void 0&&(R.visualEnabled=c);let l=document.getElementById(`brightness-slider`),u=document.getElementById(`brightness-value`);l&&n!==void 0&&(l.value=String(n)),u&&n!==void 0&&(u.textContent=`${n}%`);let d=document.getElementById(`threshold-red`),f=document.getElementById(`red-threshold-val`),p=document.getElementById(`threshold-yellow`),m=document.getElementById(`yellow-threshold-val`),h=document.getElementById(`green-starts-val`);if(d&&r!==void 0&&(d.value=String(r)),f&&r!==void 0&&(f.textContent=String(r)),p&&i!==void 0&&(p.value=String(i)),m&&i!==void 0&&(m.textContent=String(i)),h&&i!==void 0&&(h.textContent=String(i)),document.querySelectorAll(`.detection-mode-btn`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.mode)===R.advanced.detectionMode)}),t!==void 0||o!==void 0){document.querySelectorAll(`.sector-count-btn[data-count]`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.count)===R.advanced.sectorCount)});let e=document.getElementById(`sector-toggles-container`);e&&(e.innerHTML=q(),X())}let g=document.getElementById(`audio-enable-btn`),_=document.getElementById(`audio-mode-cards`);g&&(g.classList.toggle(`active`,R.audioEnabled),g.textContent=R.audioEnabled?`Enabled`:`Disabled`),_?.classList.toggle(`section-disabled`,!R.audioEnabled);let v=document.getElementById(`visual-enable-btn`),y=document.getElementById(`visual-mode-cards`);v&&(v.classList.toggle(`active`,R.visualEnabled),v.textContent=R.visualEnabled?`Enabled`:`Disabled`),y?.classList.toggle(`section-disabled`,!R.visualEnabled),W()}function Y(){let e=M(120,N,100,!1),t=M(120,P,100,!1),{thresholds:n,sectorCount:r,brightness:i,detectionMode:a}=R.advanced,o=M(220,U,i,!0,F(r)),s=q();return`

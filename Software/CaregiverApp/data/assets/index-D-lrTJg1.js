          ...
          <div class="subsection${z.audioEnabled&&z.selectedAudioMode===`tonal`?``:` section-hidden`}" id="tonal-settings">
            ...
            <div class="tone-zone">
              ...
              <div class="tone-control-row">
                ...
                <input type="range" id="tone-red-tempo" min="50" max="2000" value="${a.redTempoMs}" />
            ...
            <div class="tone-zone">
              ...
              <div class="tone-control-row">
                <span class="tone-axis-label">Tempo</span>
                <span class="tone-end-label">Slow</span>
                <input type="range" id="tone-orange-tempo" min="50" max="2000" value="${a.orangeTempoMs}" />
                <span class="tone-end-label">Rapid</span>
            ...
            <div class="tone-zone">
              ...
              <div class="tone-control-row">
                <span class="tone-axis-label">Tempo</span>
                <span class="tone-end-label">Slow</span>
                <input type="range" id="tone-yellow-tempo" min="50" max="2000" value="${a.yellowTempoMs}" />
                <span class="tone-end-label">Rapid</span>

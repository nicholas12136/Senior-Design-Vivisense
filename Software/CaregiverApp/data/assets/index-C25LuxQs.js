(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`<svg viewBox="0 0 100 100">
  ...
  ${d}
  ${p}
</svg>`}function P(e){return e.ring===5?D:e.sector===`N`?C:e.sector===`SE`?w:e.sector===`SW`?T:E}function F(e){return e.ring===5?D:e.ring===4&&Math.abs(e.angleDeg)<20?C:e.ring===2&&e.angleDeg>85&&e.angleDeg<130?w:e.ring===0&&e.angleDeg<-90&&e.angleDeg>-130?T:S}function I(e){return e===4?ee:e===8?k:O}function L(e){return Object.fromEntries(I(e).map(e=>[e,!0]))}function R(){return{audioEnabled:!1,visualEnabled:!1,selectedMode:`sector`,selectedAudioMode:null,obstacleVolume:200,advanced:{thresholds:{redMax:60,orangeMax:105,yellowMax:150},sectorCount:6,activeSectors:L(6),brightness:20,tones:{redPitchHz:1200,redTempoMs:150,orangePitchHz:800,orangeTempoMs:500,yellowPitchHz:400,yellowTempoMs:1e3}}}}var z=R(),B=null,V=0,H=1200;function U(){let e=document.getElementById(`tonal-settings`);if(!e)return;let t=z.audioEnabled&&z.selectedAudioMode===`tonal`;e.classList.toggle(`section-hidden`,!t)}function W(){let{thresholds:e,sectorCount:t,brightness:n,tones:r}=z.advanced,i=I(t).map(e=>z.advanced.activeSectors[e]??!0);h({type:`config`,zoneMode:t,brightness:n,redThreshold:e.redMax,orangeThreshold:e.orangeMax,yellowThreshold:e.yellowMax,activeSectors:i,renderMode:+(z.selectedMode===`radar`),audioEnabled:z.audioEnabled&&z.selectedAudioMode!==null,audioMode:+(z.selectedAudioMode===`verbal`),obstacleVolume:z.obstacleVolume,visualEnabled:z.visualEnabled,toneRedPitchHz:r.redPitchHz,toneRedTempoMs:r.redTempoMs,toneOrangePitchHz:r.orangePitchHz,toneOrangeTempoMs:r.orangeTempoMs,toneYellowPitchHz:r.yellowPitchHz,toneYellowTempoMs:r.yellowTempoMs})}function G(){return I(z.advanced.sectorCount).map(e=>`<button class="sector-toggle${z.advanced.activeSectors[e]??!1?` active`:``}" data-sector="${e}">${e}</button>`).join(``)}function K(){document.querySelectorAll(`.mode-card[data-mode]`).forEach(e=>{e.classList.toggle(`selected`,e.dataset.mode===z.selectedMode)})}function q(){V=Date.now()}function J(e){let t=e.zoneMode,n=e.brightness,r=e.redThreshold,i=e.orangeThreshold,a=e.yellowThreshold,o=e.renderMode,s=e.activeSectors;e.audioEnabled;let c=e.visualEnabled,l=e.obstacleVolume;t!==void 0&&[4,6,8].includes(t)&&(z.advanced.sectorCount=t),n!==void 0&&(z.advanced.brightness=n);let u=Date.now()-V<H;u||(r!==void 0&&(z.advanced.thresholds.redMax=r),i!==void 0&&(z.advanced.thresholds.orangeMax=i),a!==void 0&&(z.advanced.thresholds.yellowMax=a)),o!==void 0&&(o===0||o===1)&&(z.selectedMode=o===1?`radar`:`sector`),s!==void 0&&I(z.advanced.sectorCount).forEach((e,t)=>{z.advanced.activeSectors[e]=s[t]??!0}),c!==void 0&&(z.visualEnabled=c);let d=document.activeElement;for(let[t,n,r]of[[`redPitchHz`,`tone-red-pitch`,`tone-red-pitch-val`],[`redTempoMs`,`tone-red-tempo`,`tone-red-tempo-val`],[`orangePitchHz`,`tone-orange-pitch`,`tone-orange-pitch-val`],[`orangeTempoMs`,`tone-orange-tempo`,`tone-orange-tempo-val`],[`yellowPitchHz`,`tone-yellow-pitch`,`tone-yellow-pitch-val`],[`yellowTempoMs`,`tone-yellow-tempo`,`tone-yellow-tempo-val`]]){let i=e[`tone${t.charAt(0).toUpperCase()}${t.slice(1)}`];if(i===void 0)continue;z.advanced.tones[t]=i;let a=document.getElementById(n),o=document.getElementById(r);a&&d!==a&&(a.value=String(t.endsWith(`Ms`)?2050-i:i)),o&&(o.textContent=t.endsWith(`Hz`)?`${i} Hz`:`${i} ms`)}let f=document.getElementById(`brightness-slider`),p=document.getElementById(`brightness-value`);f&&n!==void 0&&d!==f&&(f.value=String(n)),p&&n!==void 0&&(p.textContent=`${n}%`),l!==void 0&&(z.obstacleVolume=l);let m=document.getElementById(`obstacle-volume-slider`),h=document.getElementById(`obstacle-volume-value`);m&&l!==void 0&&d!==m&&(m.value=String(Math.round(l/2.55))),h&&l!==void 0&&(h.textContent=`${Math.round(l/2.55)}%`);let g=document.getElementById(`threshold-red`),_=document.getElementById(`red-threshold-val`),v=document.getElementById(`threshold-orange`),y=document.getElementById(`orange-threshold-val`),b=document.getElementById(`threshold-yellow`),x=document.getElementById(`yellow-threshold-val`),S=document.getElementById(`green-starts-val`);if(g&&r!==void 0&&d!==g&&!u&&(g.value=String(r)),_&&r!==void 0&&!u&&(_.textContent=String(r)),v&&i!==void 0&&d!==v&&!u&&(v.value=String(i)),y&&i!==void 0&&!u&&(y.textContent=String(i)),b&&a!==void 0&&d!==b&&!u&&(b.value=String(a)),x&&a!==void 0&&!u&&(x.textContent=String(a)),S&&a!==void 0&&!u&&(S.textContent=String(a)),K(),U(),t!==void 0||s!==void 0){document.querySelectorAll(`.sector-count-btn[data-count]`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.count)===z.advanced.sectorCount)});let e=document.getElementById(`sector-toggles-container`);e&&(e.innerHTML=G(),X())}let C=document.getElementById(`audio-enable-btn`),w=document.getElementById(`audio-mode-cards`);C&&(C.classList.toggle(`active`,z.audioEnabled),C.textContent=z.audioEnabled?`Enabled`:`Disabled`),w?.classList.toggle(`section-disabled`,!z.audioEnabled);let T=document.getElementById(`visual-enable-btn`),E=document.getElementById(`visual-mode-cards`);T&&(T.classList.toggle(`active`,z.visualEnabled),T.textContent=z.visualEnabled?`Enabled`:`Disabled`),E?.classList.toggle(`section-disabled`,!z.visualEnabled)}function Y(){let e=N(120,P,100,!1),t=N(120,F,100,!1),{thresholds:n,sectorCount:r,brightness:i,tones:a}=z.advanced,o=G();return`
      ...
      <section class="config-section">
        ...
        <div class="advanced-body" id="advanced-body">
          ...
          <div class="subsection${z.audioEnabled&&z.selectedAudioMode===`tonal`?``:` section-hidden`}" id="tonal-settings">
            ...
            <div class="subsection">
              <h3 class="subsection-title">Obstacle Audio Volume - <span id="obstacle-volume-value">${Math.round(z.obstacleVolume/2.55)}%</span></h3>
              <input type="range" id="obstacle-volume-slider" min="0" max="100" value="${Math.round(z.obstacleVolume/2.55)}" />
            </div>
    ...
    </main>`}function X(){document.querySelectorAll(`.sector-toggle`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.sector,n=z.advanced.activeSectors[t]??!1;z.advanced.activeSectors[t]=!n,e.classList.toggle(`active`,!n),W()})})}function Z(){z=R(),K();let e=document.getElementById(`audio-enable-btn`),t=document.getElementById(`audio-mode-cards`);e?.addEventListener(`click`,()=>{z.audioEnabled=!z.audioEnabled,e.classList.toggle(`active`,z.audioEnabled),e.textContent=z.audioEnabled?`Enabled`:`Disabled`,t?.classList.toggle(`section-disabled`,!z.audioEnabled),U(),W()});let n=document.getElementById(`visual-enable-btn`),r=document.getElementById(`visual-mode-cards`);n?.addEventListener(`click`,()=>{z.visualEnabled=!z.visualEnabled,n.classList.toggle(`active`,z.visualEnabled),n.textContent=z.visualEnabled?`Enabled`:`Disabled`,r?.classList.toggle(`section-disabled`,!z.visualEnabled),W()}),document.querySelectorAll(`.mode-card[data-mode]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.mode;t!==z.selectedMode&&(z.selectedMode=t,document.querySelectorAll(`.mode-card[data-mode]`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),W())})}),document.querySelectorAll(`.mode-card[data-audio-mode]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.audioMode;z.selectedAudioMode=t,document.querySelectorAll(`.mode-card[data-audio-mode]`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),U(),W()})});for(let{sliderId:e,valId:t,key:n,unit:r}of[{sliderId:`tone-red-pitch`,valId:`tone-red-pitch-val`,key:`redPitchHz`,unit:`Hz`},{sliderId:`tone-red-tempo`,valId:`tone-red-tempo-val`,key:`redTempoMs`,unit:`ms`},{sliderId:`tone-orange-pitch`,valId:`tone-orange-pitch-val`,key:`orangePitchHz`,unit:`Hz`},{sliderId:`tone-orange-tempo`,valId:`tone-orange-tempo-val`,key:`orangeTempoMs`,unit:`ms`},{sliderId:`tone-yellow-pitch`,valId:`tone-yellow-pitch-val`,key:`yellowPitchHz`,unit:`Hz`},{sliderId:`tone-yellow-tempo`,valId:`tone-yellow-tempo-val`,key:`yellowTempoMs`,unit:`ms`}]){let i=document.getElementById(e),a=document.getElementById(t);i?.addEventListener(`input`,()=>{let e=r===`ms`?2050-Number(i.value):Number(i.value);z.advanced.tones[n]=e,a&&(a.textContent=`${e} ${r}`),W()})}B&&_(B),B=e=>{let t=e;t.type===`status`&&J(t)},g(B),h({type:`getConfig`});let i=document.getElementById(`advanced-toggle`),a=document.getElementById(`advanced-body`),o=document.getElementById(`advanced-chevron`);i?.addEventListener(`click`,()=>{let e=a?.classList.toggle(`open`);o?.classList.toggle(`open`,e)});let s=document.getElementById(`threshold-red`),c=document.getElementById(`threshold-orange`),l=document.getElementById(`threshold-yellow`),u=document.getElementById(`red-threshold-val`),d=document.getElementById(`orange-threshold-val`),f=document.getElementById(`yellow-threshold-val`),p=document.getElementById(`green-starts-val`);s?.addEventListener(`input`,()=>{let e=Number(s.value);e>=z.advanced.thresholds.orangeMax&&(e=z.advanced.thresholds.orangeMax-10,s.value=String(e)),z.advanced.thresholds.redMax=e,u&&(u.textContent=String(e)),q(),refreshPreview(),W(),previewActive&&sendPreview(!0)}),c?.addEventListener(`input`,()=>{let e=Number(c.value);e<=z.advanced.thresholds.redMax&&(e=z.advanced.thresholds.redMax+10),e>=z.advanced.thresholds.yellowMax&&(e=z.advanced.thresholds.yellowMax-10),c.value=String(e),z.advanced.thresholds.orangeMax=e,d&&(d.textContent=String(e)),q(),refreshPreview(),W(),previewActive&&sendPreview(!0)}),l?.addEventListener(`input`,()=>{let e=Number(l.value);e<=z.advanced.thresholds.orangeMax&&(e=z.advanced.thresholds.orangeMax+10,l.value=String(e)),z.advanced.thresholds.yellowMax=e,f&&(f.textContent=String(e)),p&&(p.textContent=String(e)),q(),refreshPreview(),W(),previewActive&&sendPreview(!0)}),document.querySelectorAll(`.sector-count-btn[data-count]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.count);if(t===z.advanced.sectorCount)return;let n=z.advanced.activeSectors,r={};for(let e of I(t))r[e]=n[e]??!0;z.advanced.sectorCount=t,z.advanced.activeSectors=r,document.querySelectorAll(`.sector-count-btn[data-count]`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let i=document.getElementById(`sector-toggles-container`);i&&(i.innerHTML=G()),X(),W()})}),X();let m=document.getElementById(`brightness-slider`),v=document.getElementById(`brightness-value`);m?.addEventListener(`input`,()=>{z.advanced.brightness=Number(m.value),v&&(v.textContent=`${z.advanced.brightness}%`),W()});let y=document.getElementById(`obstacle-volume-slider`),b=document.getElementById(`obstacle-volume-value`);y?.addEventListener(`input`,()=>{z.obstacleVolume=Math.round(Number(y.value)*2.55),b&&(b.textContent=`${y.value}%`),W()})}function Q(){return window.location.hash||`#controller`}function $(){let e=Q(),r=document.getElementById(`app`);if(!r)return;let i,a;e===`#feedback-config`?(i=Y(),a=Z):(i=y(),a=b),r.innerHTML=t(e)+`<div id="page-content">${i}</div>`,n(),m(),a()}function te(){window.addEventListener(`hashchange`,$),$()}m(),te();
(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`<svg viewBox="0 0 100 100">
  ...
  ${d}
  ${p}
</svg>`}function F(e){return e.ring===5?D:e.sector===`N`?C:e.sector===`SE`?w:e.sector===`SW`?T:E}function I(e){return e.ring===5?D:e.ring===4&&Math.abs(e.angleDeg)<20?C:e.ring===2&&e.angleDeg>85&&e.angleDeg<130?w:e.ring===0&&e.angleDeg<-90&&e.angleDeg>-130?T:S}function L(e){return e===4?O:e===8?A:k}function R(e){return Object.fromEntries(L(e).map(e=>[e,!0]))}function z(){return{audioEnabled:!0,visualEnabled:!0,selectedMode:`sector`,selectedAudioMode:null,advanced:{thresholds:{redMax:60,orangeMax:105,yellowMax:150},sectorCount:6,activeSectors:R(6),brightness:20}}}var B=z(),V=!1,H=null,U=[280,220,160,110,60,0];function W(e){return e<=B.advanced.thresholds.redMax?C:e<=B.advanced.thresholds.orangeMax?w:e<=B.advanced.thresholds.yellowMax?T:E}function G(e){return e.ring===5?D:B.advanced.activeSectors[e.sector]?W(U[e.ring]??9999):S}function K(){let e=document.getElementById(`advanced-preview`);if(!e)return;let t=L(B.advanced.sectorCount);e.innerHTML=P(220,G,B.advanced.brightness,!0,t)}function q(){let{thresholds:e,sectorCount:t,brightness:n}=B.advanced,r=L(t).map(e=>B.advanced.activeSectors[e]??!0);h({type:`config`,zoneMode:t,brightness:n,redThreshold:e.redMax,orangeThreshold:e.orangeMax,yellowThreshold:e.yellowMax,activeSectors:r,renderMode:+(B.selectedMode===`radar`),audioEnabled:B.audioEnabled,visualEnabled:B.visualEnabled})}function J(e){if(!e){h({type:`preview`,active:!1});return}let{thresholds:t,sectorCount:n,brightness:r}=B.advanced,i=L(n).map(e=>B.advanced.activeSectors[e]??!0);h({type:`preview`,active:!0,zoneMode:n,brightness:r,redThreshold:t.redMax,orangeThreshold:t.orangeMax,yellowThreshold:t.yellowMax,activeSectors:i})}function Y(){return L(B.advanced.sectorCount).map(e=>`<button class="sector-toggle${B.advanced.activeSectors[e]??!1?` active`:``}" data-sector="${e}">${e}</button>`).join(``)}function X(){document.querySelectorAll(`.mode-card[data-mode]`).forEach(e=>{e.classList.toggle(`selected`,e.dataset.mode===B.selectedMode)})}function Z(e){let t=e.zoneMode,n=e.brightness,r=e.redThreshold,i=e.orangeThreshold,a=e.yellowThreshold,o=e.renderMode,s=e.activeSectors,c=e.audioEnabled,l=e.visualEnabled;t!==void 0&&[4,6,8].includes(t)&&(B.advanced.sectorCount=t),n!==void 0&&(B.advanced.brightness=n),r!==void 0&&(B.advanced.thresholds.redMax=r),i!==void 0&&(B.advanced.thresholds.orangeMax=i),a!==void 0&&(B.advanced.thresholds.yellowMax=a),o!==void 0&&(o===0||o===1)&&(B.selectedMode=o===1?`radar`:`sector`),s!==void 0&&L(B.advanced.sectorCount).forEach((e,t)=>{B.advanced.activeSectors[e]=s[t]??!0}),c!==void 0&&(B.audioEnabled=c),l!==void 0&&(B.visualEnabled=l);let u=document.getElementById(`brightness-slider`),d=document.getElementById(`brightness-value`),f=document.activeElement;u&&n!==void 0&&f!==u&&(u.value=String(n)),d&&n!==void 0&&(d.textContent=`${n}%`);let p=document.getElementById(`threshold-red`),m=document.getElementById(`red-threshold-val`),h=document.getElementById(`threshold-orange`),g=document.getElementById(`orange-threshold-val`),_=document.getElementById(`threshold-yellow`),v=document.getElementById(`yellow-threshold-val`),y=document.getElementById(`green-starts-val`);if(p&&r!==void 0&&f!==p&&(p.value=String(r)),m&&r!==void 0&&(m.textContent=String(r)),h&&i!==void 0&&f!==h&&(h.value=String(i)),g&&i!==void 0&&(g.textContent=String(i)),_&&a!==void 0&&f!==_&&(_.value=String(a)),v&&a!==void 0&&(v.textContent=String(a)),y&&a!==void 0&&(y.textContent=String(a)),X(),t!==void 0||s!==void 0){document.querySelectorAll(`.sector-count-btn[data-count]`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.count)===B.advanced.sectorCount)});let e=document.getElementById(`sector-toggles-container`);e&&(e.innerHTML=Y(),Q())}let b=document.getElementById(`audio-enable-btn`),x=document.getElementById(`audio-mode-cards`);b&&(b.classList.toggle(`active`,B.audioEnabled),b.textContent=B.audioEnabled?`Enabled`:`Disabled`),x?.classList.toggle(`section-disabled`,!B.audioEnabled);let S=document.getElementById(`visual-enable-btn`),C=document.getElementById(`visual-mode-cards`);S&&(S.classList.toggle(`active`,B.visualEnabled),S.textContent=B.visualEnabled?`Enabled`:`Disabled`),C?.classList.toggle(`section-disabled`,!B.visualEnabled),K()}function ee(){let e=P(120,F,100,!1),t=P(120,I,100,!1),{thresholds:n,sectorCount:r,brightness:i}=B.advanced,a=P(220,G,i,!0,L(r)),o=Y();return`
